                ...
                <div className={"banner_frm_wraper"}>
                  ...
                  >
                    <div className={"calculator_area"}>
                      <form className={"main_form"} id={"main_form"}>
                                  ...
                                  <div className={"col-md-12"}>
                                    <div className={"form-group"}>
                                      ...
                                      >
                                        ...
                                        <optgroup label={"Proposals Plans"}>
                                          <option value={"73"}>
                                            {"Capstone Proposal"}
                                          </option>
                                          <option value={"74"}>
                                        ...
                                        <optgroup
                                          label={"Technical Scientific Work"}
                                        >
                                          <option value={"78"}>
                                            {"Case Analysis"}
                                          </option>
                                    ...
                                    <div className={"form-group"}>
                                      ...
                                      <HeroSelect defaultValue={"35"}>
                                        ...
                                        <optgroup label={"Programming"}>
                                          ...
                                          <option value={"226"}>{"PHP"}</option>
                                          <option value={"227"}>{"C#"}</option>
                                          <option value={"228"}>
                                            {"Python"}
                                          </option>
                                          <option value={"229"}>
